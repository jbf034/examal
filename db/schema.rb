...
ActiveRecord::Schema.define(version: 20200928024204) do
  ...
  add_index "exams_subjects", ["exam_id", "subject_id"], name: "index_exams_subjects_on_exam_id_and_subject_id", using: :btree
